  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" v-show="showSearch" :inline="true">
      ...
      <el-form-item label="角色类型" prop="roleType">
        <el-select v-model="queryParams.roleType" placeholder="请选择角色类型" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色类型" width="150" prop="roleType">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="角色类型" prop="roleType">
          <el-select :disabled="this.flag" v-model="form.roleType" placeholder="请选择角色类型">
            <el-option
              v-for="dict in dict.type.sys_role_type"
              :key="dict.value"
              :label="dict.label"
  ...
  methods: {
    ...
    getFlag() {
      getInfo().then(res => {
        ...
        this.flag = !this.hasRole(roles, "admin");
        if (this.flag) {
